...
def _resnet(
    ...
    model = ResNet_FiLM(block, layers, **model_kwargs)
...
def resnet18(*, weights=None, progress: bool = True, **kwargs: Any) -> ResNet_FiLM:
...
def resnet34(*, weights=None, progress: bool = True, **kwargs: Any) -> ResNet_FiLM:
...
def resnet101(*, weights=None, progress: bool = True, **kwargs: Any) -> ResNet_FiLM:
